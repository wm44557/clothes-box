...
const Checkout1 = () => {
    ...
    const {basket, basketPrice, removeFromBasket, clearBasket} = useContext(AppContext);
                ...
                <div className="flex flex-col justify-start items-start w-full space-y-9">
                    <div className="flex justify-start flex-col items-start space-y-2">
                        <button className="flex flex-row items-center text-gray-600 hover:text-gray-500 space-x-1">
                            <svg className="fill-stroke" width="14" height="14" viewBox="0 0 14 14" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path d="M2.91681 7H11.0835" stroke="currentColor" strokeWidth="0.666667"
                                      strokeLinecap="round" strokeLinejoin="round"/>
                                <path d="M2.91681 7L5.25014 9.33333" stroke="currentColor" strokeWidth="0.666667"
                                      strokeLinecap="round" strokeLinejoin="round"/>
                                <path d="M2.91681 7.00002L5.25014 4.66669" stroke="currentColor" strokeWidth="0.666667"
                                      strokeLinecap="round" strokeLinejoin="round"/>
                            </svg>
                            <Link to="/" className="text-sm leading-none">Back</Link>
                        </button>
                    ...
                    <div
                                    ...
                                    <div className="ml-4 flex-1 flex flex-col">
                                        <div>
                                            <div
                                                ...
                                                <h3>
                                                    <a href={product.href}>{product.nameItem}</a>
                                                </h3>
                                                <p
                                                    className="ml-4">
                        ...
                        <div className="p-8 bg-gray-100 flex flex-col lg:w-full xl:w-3/5">
                            <button
                                ...
                                <div>
                                    <p className="text-base leading-4 rounded-md ">Pay</p>
                                </div>
                            </button>

                            <div className="flex flex-row justify-center items-center mt-6">
                                <hr className="border w-full"/>
                                <p className="flex flex-shrink-0 px-4 text-base leading-4 text-gray-600">or pay with
                                    card</p>
                                <hr className="border w-full"/>
                            </div>
                            ...
                            <div className="mt-2 flex-col">
                                <div>
                                    <input
                                        ...
                                        type="email" placeholder="Name on card"/>
                                </div>
                            </div>
                            ...
                            <div className="mt-2 flex-col">
                                <div className="relative">
                                    ...
                                    <svg onClick={() => setMenu(!menu)}
                                         ...
                                         xmlns="http://www.w3.org/2000/svg">
                                        <path d="M3.5 5.75L8 10.25L12.5 5.75" stroke="#27272A" strokeLinecap="round"
                                              strokeLinejoin="round"/>
                                    </svg>
                                    <div
                                        className={"mt-1 absolute z-10 w-full flex bg-gray-50 justify-start flex-col text-gray-600 " + (menu ? "block" : "hidden")}>
